...
export const HighlightIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M2 1.5C1.44772 1.5 1 1.94772 1 2.5V4V13.5C1 14.0523 1.44772 14.5 2 14.5H14C14.5523 14.5 15 14.0523 15 13.5V4V2.5C15 1.94772 14.5523 1.5 14 1.5H2ZM2.5 4V3H13.5V4V13H2.5V4ZM4 5H12V6.5H4V5ZM10 8H4V9.5H10V8ZM7 11H4V12.5H7V11Z"
        fill="currentColor"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M5 6.25H11V5.25H5V6.25ZM5 9.25H9V8.25H5V9.25ZM5 12.25H6V11.25H5V12.25Z"
        fill="currentColor"
